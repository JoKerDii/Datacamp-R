---
title: "Datacamp_Importing_Data_in_R_(Part1)__Reproducible_Excel_work_with_XLConnect"
author: "dizhen"
date: "2019Äê4ÔÂ4ÈÕ"
...
readWorksheet(my_book,sheet = getSheets(my_book)[2])
```
...
1. Use createSheet(), to create a new sheet in my_book, named "data_summary".

2. Use getSheets() to verify that my_book now represents an Excel file with four sheets.
...
1. Use writeWorksheet() to populate the "data_summary" sheet with the summ data frame.

2. Call saveWorkbook() to store the adapted Excel workbook as a new file, "summary.xlsx"
...
3. Use removeSheet() to remove the fourth sheet from my_book. The sheet name is "summary".
